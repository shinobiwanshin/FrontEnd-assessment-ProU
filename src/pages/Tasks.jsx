...
const initialEmployees = [
  { id: "1", name: "Alice Johnson", position: "Frontend Developer" },
  { id: "2", name: "Bob Smith", position: "Backend Developer" },
  { id: "3", name: "Carol Williams", position: "UI/UX Designer" },
  { id: "4", name: "David Brown", position: "Project Manager" },
  { id: "5", name: "Emma Davis", position: "HR Specialist" },
  { id: "6", name: "Frank Miller", position: "DevOps Engineer" },
  { id: "7", name: "Grace Lee", position: "Data Analyst" },
  { id: "8", name: "Henry Wilson", position: "QA Engineer" },
];
...
const initialTasks = [
  {
    ...
    description: "Implement user authentication flow with email and password",
    status: "completed",
    priority: "high",
    assigned_to: "1",
    due_date: "2025-12-01",
  ...
  },
  {
    ...
    description: "Create main dashboard with charts and statistics",
    status: "in_progress",
    priority: "high",
    assigned_to: "1",
    due_date: "2025-12-05",
  ...
  },
  {
    ...
    description: "Design wireframes for new feature pages",
    status: "in_progress",
    priority: "medium",
    assigned_to: "3",
    due_date: "2025-12-03",
  ...
  },
  {
    ...
    description: "Plan tasks for next sprint cycle",
    status: "completed",
    priority: "medium",
    assigned_to: "4",
    due_date: "2025-11-25",
  ...
  },
  {
    ...
    description: "Prepare presentation slides for client demo",
    status: "pending",
    priority: "high",
    assigned_to: "4",
    due_date: "2025-12-02",
  ...
  },
  {
    ...
    description: "Build data visualization for metrics",
    status: "pending",
    priority: "medium",
    assigned_to: "7",
    due_date: "2025-12-20",
  ...
  },
  {
    ...
    description: "Improve application load times",
    status: "pending",
    priority: "low",
    assigned_to: "1",
    due_date: "2025-12-25",
